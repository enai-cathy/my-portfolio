...
//           <motion.div
//             key={name}
//             className={`backdrop-blur-lg bg-white/10 ${border} border-2 rounded-xl text-center w-full max-w-[120px] p-6 text-gray-500 transition-transform transform hover:scale-105 ${glow} hover:shadow-[0_0_25px_white]`}
...
//         <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600 list-disc list-inside px-4">
...
const skills = [
  ...
  { name: "Next.js", image: "/images/next-logo.png", color: "#000000" },
  { name: "TypeScript", image: "/images/TS-logo.png", color: "#3178c6" },
   { name: "Node.js", image: "/images/node-js-logo.png", color: "#c7e09eff" },
  { name: "Tailwind CSS", image: "/images/tailwind.png", color: "#38bdf8" },
  { name: "JavaScript", image: "/images/JS-logo.png", color: "#f7df1e" },
  { name: "Figma", image: "/images/figma-logo.png", color: "#f24e1e" },
  { name: "MongoDB", image: "/images/mongoDB.png", color: "#71a871ff" },
   { name: "PostgreSQL", image: "/images/postgresql-logo.png", color: "#8ed4e9ff" },
];
const softSkills = [
  "Empathetic communicator & active listener",
  "Cross-functional collaboration with designers & engineers",
